...
class DepthNet(nn.Module):
    ...
    def forward(self, features, proj_matrices, interval, depth_values, num_depth, cost_regularization, prob_volume_init=None, view_weights=None):
        """forward.
...
## UniMVSNet
        ...
        if view_weights == None:
            ...
            return {"depth": depth,  "photometric_confidence": photometric_confidence, "prob_volume": prob_volume, "depth_values": depth_values, "interval":interval}, view_weights.detach()
        else:
            return {"depth": depth,  "photometric_confidence": photometric_confidence, "prob_volume": prob_volume, "depth_values": depth_values, "interval":interval}
...
class TransMVSNet(nn.Module):
    ...
    def forward(self, imgs, proj_matrices, depth_values, test_tnt=False):
        ...
        for stage_idx in range(self.num_stage):
            ...
            # [B, D, H, W]
            depth_range_samples, interval = get_depth_range_samples(cur_depth=cur_depth,
