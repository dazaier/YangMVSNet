#!/usr/bin/env bash
# run this script in the root path of project
MVS_TRAINING="/gemini/data-1/mvs_training/dtu/" # path to dataset mvs_training
LOG_DIR="/gemini/YangOutputs/outputs/dtu_training" # path to checkpoints
if [ ! -d $LOG_DIR ]; then
	mkdir -p $LOG_DIR
fi

NGPUS=4 #number of GPU you wanna use
BATCH_SIZE=1
